...
if __name__ == "__main__":
    ...
    # Configurar buffer de recepción antes de recibir mensajes
    response = send_at_command("AT+RXCONF=10,100")  # Ejemplo de configuración de buffer
    print(f"Configuración de buffer: {response}")
