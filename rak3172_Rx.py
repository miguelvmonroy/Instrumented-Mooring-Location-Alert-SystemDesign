...
# Forzar la codificación UTF-8 sin usar fileno
class UTF8Stdout:
    ...
    def write(self, text):
        try:
            ...
            # Si hay un error de codificación, intenta escribir en UTF-8
            self.original_stdout.buffer.write(text.encode('utf-8'))

    def flush(self):
        self.original_stdout.flush()

# Reemplazar sys.stdout con un objeto que maneje UTF-8
