...
def send_at_command(command):
    ...
    try:
        with serial.Serial(PORT, BAUDRATE, timeout=5) as ser:
            ...
            time.sleep(2)  # Aumenta el tiempo de espera para la respuesta
...
if __name__ == "__main__":
    ...
    if "OK" not in send_at_command("AT+P2P=915000000,7,125,1,14,8"):
        print("Error al configurar los parámetros P2P.")
        exit()
