...
def main():
    ...
    # **🔹 Solución 1: Desactivar P2P RX antes de configurar**
    send_at_command("AT+PRECV=0", wait_time=1)

    # **🔹 Solución 2: Configurar correctamente P2P**
    send_at_command("AT+NWM=0")
    send_at_command("AT+P2P=915000000,7,125,1,8,14")  #  COMANDO CORREGIDO
