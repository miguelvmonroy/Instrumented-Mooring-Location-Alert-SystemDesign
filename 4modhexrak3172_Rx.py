...
if __name__ == "__main__":
    ...
    while True:
        ...
        response = send_at_command("AT+RECV=?")  # Intentamos recibir, pero puede que no sea necesario

        if "AT_MODE_NO_SUPPORT" in response:
            print("Error: Modo no soportado. Verificando estado de recepción...")
            # Si el comando AT+RECV=? no es soportado, solo procesamos los eventos de recepción
